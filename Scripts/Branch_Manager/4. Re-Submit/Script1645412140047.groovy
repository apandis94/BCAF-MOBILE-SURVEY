...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathmobilesurvey) + 'Survey Kendaraan 4.1') + '.png', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/Submit/android.widget.LinearLayout'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathmobilesurvey) + 'Survey Kendaraan 4.2') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathmobilesurvey) + 'Survey Kendaraan 4.3') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('Status/android.widget.RadioButton - Approved (1)'), 0)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathmobilesurvey) + 'Survey Kendaraan 4.10') + '.png', FailureHandling.STOP_ON_FAILURE)

not_run: Mobile.checkElement(findTestObject('Status/android.widget.Button - SUBMIT'), 0)
